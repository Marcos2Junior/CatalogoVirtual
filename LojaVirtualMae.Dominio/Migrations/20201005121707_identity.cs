...
namespace LojaVirtualMae.Dominio.Migrations
{
    public partial class identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Prepedidos_AspNetUsers_UsuarioID",
                table: "Prepedidos",
                column: "UsuarioID",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Apelido = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    ...
                    ReceberEmail = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ReceberMensagem = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Senha = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    TelefoneFixo = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    TelefoneMovel = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true)
                },
                constraints: table =>
                {
