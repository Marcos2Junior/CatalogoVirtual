...
namespace LojaVirtualMae.API.Modelos
{
    public class ProdutoModelo
    {
        ...
        [StringLength(50, MinimumLength = 4, ErrorMessage = "{0} tamanho deve ser entre {2} e {1} caracteres")]
        ...
        [Range(0.01, 50000.0, ErrorMessage = " {0} deve ser entre {1} a {2}")]
        [DisplayFormat(DataFormatString = "{0:F2}")]
        public decimal PrecoAtual { get; set; }

        [Range(0, 50000.0, ErrorMessage = " {0} deve ser entre {1} a {2}")]
        [DisplayFormat(DataFormatString = "{0:F2}")]
        public decimal? PrecoAntigo { get; set; }
        public decimal? DescontoPorcentagem { get; set; }

        [Required(ErrorMessage = "{0} Obrigatório")]
        [Range(0, 50000, ErrorMessage = " {0} deve ser entre {1} a {2}")]
